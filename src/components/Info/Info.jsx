...
function Info() {
  return (
   ...
   <div className='flex justify-start item-start'>
      ...
      <div className='flex flex-col gap-3 px-10 md:px-12 lg:px-30 mt-20 mb-20 justify-center'>
        
        <h1 className='font-cormorant font-semibold tracking-[1px] text-center text-[24px] sm:text-lg md:text-[24px] lg:text-5xl text-[#170809]'>Elevate Your Elegance with Our Exquisite Lehengas</h1>
